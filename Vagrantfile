...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "devone-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/test-company"
  #   chef.validation_client_name = "test-company-validator"
  #   chef.validation_key_path = ".chef/test-company-validator.pem"
  # end
end
